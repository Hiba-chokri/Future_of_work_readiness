#!/usr/bin/env python3
"""
Add comprehensive Data Analytics quizzes to the database
...
def add_data_analytics_quizzes():
    """Add all Data Analytics quizzes"""
    db = SessionLocal()
    
    try:
        # Get Data Analytics specialization (ID should be 1)
        ...
        print(f"✅ Found Data Analytics specialization (ID: {frontend_spec.id})")
        ...
        print("\n📝 Adding Level 4: Data Analytics Expert - React & Frameworks...")
        quiz_level_4 = models.Quiz(
            title="Data Analytics Expert - Level 4",
        ...
        quiz_level_5 = models.Quiz(
            title="Data Analytics Strategic - Level 5",
